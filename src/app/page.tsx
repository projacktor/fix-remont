  ...
  return (
      <main className="home_content">
        ...
        <div className={`flex flex-row gap-4`}>
            ...
            <TapeSection svg={rublIcon as string} altName={"rublIcon"} text={<p>100% гарантия фиксированной <br/> сметы</p>}/>
            <TapeSection svg={shieldIcon as string} altName={"shieldIcon"} text={<p>Все финансовые риски берём <br/> на себя</p>}/>
            <TapeSection svg={lampIcon as string} altName={"lampIcon"} text={<p>36 готовых <br/> дизнай-проектов</p>}/>
            <TapeSection svg={flagIcon as string} altName={"flagIcon"} text={<p>Всё берем на себя <br/> и работаем под ключ</p>}/>
        </div>
