...
function Page() {
  ...
  const data: PrimaryNews[] = [
    ...
    {
      section: 'Ремонт',
      heading: 'Обновление функционала для расчета стоимости ремонта',
      link: param
    },
    {
      section: 'Ремонт',
      heading: "Новые возможности в разделе 'Ремонт' на платформе",
      link: param
    },
    { section: 'Ремонт', heading: 'Улучшение интерфейса для удобства пользователей', link: param },
    { section: 'Ремонт', heading: 'Расширенные параметры расчета ремонта', link: param },
    {
      section: 'Ремонт',
      heading: 'Как избежать ошибок при расчете стоимости ремонта?',
      link: param
    },
    { section: 'Ремонт', heading: 'Улучшение интерфейса для удобства пользователей', link: param },
    { section: 'Ремонт', heading: 'Расширенные параметры расчета ремонта', link: param },
