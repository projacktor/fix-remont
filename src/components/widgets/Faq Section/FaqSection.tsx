  ...
  return (
    <section className="relative flex h-full w-full flex-col justify-around">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="order-1 flex max-h-[14.2rem] w-1/2 flex-row items-center justify-around rounded-3xl bg-color-dark px-8">
          <Image
            src={photo as unknown as string}
            alt={'CEO photo picture'}
            className={`z-10`}
            quality={100}
          />
          <div className={`z-20 flex w-max flex-col items-start justify-around gap-4`}>
            ...
            <p className="text-sm font-extralight leading-normal text-white">
