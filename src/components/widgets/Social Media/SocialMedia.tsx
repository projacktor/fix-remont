...
const SocialMedia = () => {
    return (
        <div className="relative w-full h-4/5">
            ...
            <div className="flex items-center flex-row gap-8 w-full mt-8">
                <a
                ...
                <div className="w-1/2 gap-10 flex flex-col justify-between items-center">
                    <SocialMediaBullet image={vkIcon as string} name={"ВКонтакте"} sub={"1 500"} link={"https://vk.com/fix.remoont?from=search"} />
                    <SocialMediaBullet image={instagramIcon as string} name={"Instagram"} sub={"15 500"} link={"https://instagram.com/fix_remont.ru"}/>
                    <SocialMediaBullet image={telegramIcon as string} name={"Telegram"} sub={"500"} link={"https://t.me/FIX_REMONT_bot"} />
                </div>
            </div>
        </div>
    );
