...
function MegaboxSection() {
    return (
        <div className="flex flex-row items-center w-full min-h-screen gap-6">
            <div className={`${style.bg} max-w-1/2 w-[95svw] min-h-[92svh] bg-cover bg-center rounded-xl`}>
            ...
            <div className="flex flex-col gap-7 items-center w-1/2 max-w-1/2">
                ...
                <div className="flex flex-row gap-7">
                    <HoverSection name="Ремонт" text={<p>Без визитов на объект. <br/> Заезжайте в готовую <br/> квартиру уже через <br/> 6-8 месяцев</p>} link={""}/>
                    <HoverSection name="Строительство" text={<p>Без визитов на объект. <br/>  Заезжайте в готовую <br/> квартиру уже через <br/> 6-8 месяцев</p>} link={""}/>
                    <HoverSection name="Партнерская программа" text={<p>Подходит для физ.лиц, <br/> застройщиков, <br/> риелторов</p>} link={""}/>
                </div>
            </div>
        </div>
    );
