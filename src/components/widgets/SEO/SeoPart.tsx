    ...
    return (
        <div className="relative w-[90rem] h-[55%] mb-20">
            <div
                ...
                <p className="text-sm leading-[171%]">Amet minim mollit non deserunt ullamco est sit aliqua dolor do
                    amet sint.
                ...
                <ul className="list-disc list-inside">
                    <li className="text-sm leading-[171%]">do amet sint. Velit officia consequat duis enim velit mollit.
                        Exercitation veniam consequat sunt
                        nostrud amet. Amet minim mollit non deserunt ullamco est sit aliqua dolor
                    </li>
                    <li className="text-sm leading-[171%]">Amet minim mollit non deserunt ullamco est sit aliqua
                        dolor.
                    </li>
                    <li className="text-sm leading-[171%]">do amet sint. Velit officia consequat duis enim velit mollit.
                        Exercitation veniam consequat sunt
